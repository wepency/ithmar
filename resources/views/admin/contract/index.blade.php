                                            ...
                                            <td>
                                                ...
                                                @if(is_admin() && auth()->id() == 75)
                                                    @if(is_null($row->excluded_from_bonds))
                                                        <form onsubmit="return confirm('سيتم استبعاد العقد من جميع السندات وإعادة احتساب السندات المتأثرة. هل تريد المتابعة؟')"
                                                              style="display: inline-block;margin: 0"
                                                              action="{{admin_url('contract/'.$row->id.'/bonds/exclude')}}"
                                                              method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <button class="btn btn-default" type="submit"
                                                                    ...
                                                                    title="استبعاد من السندات"><i
                                                                        class="fa fa-ban"></i></button>
                                                        </form>
                                                    @else
                                                        <form onsubmit="return confirm('سيتم إرجاع العقد للسندات وإعادة احتساب السندات المتأثرة. هل تريد المتابعة؟')"
                                                              style="display: inline-block;margin: 0"
                                                              action="{{admin_url('contract/'.$row->id.'/bonds/include')}}"
                                                              method="POST">
                                                            @csrf
                                                            @method('PUT')
