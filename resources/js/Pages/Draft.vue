<template>
    <main>
        <div class="container">
            <div v-if="!is_cancelled" class="buttons-wrap">
                <ShareNetwork
                    network="WhatsApp"
                    :url="url"
                    title="عقد إيجار"
        ...
        <div class="pdf-container">
            ...
            <div class="pdf" :class="{'blurred': is_cancelled}" id="printMe">
                ...
                <div class="section-three">
                    <table class="table table-bordered">
                        ...
                        <tr v-for="(car, index) in cars">
                            ...
                            <td v-if="index === 0" class="cus-ceil text-center" style="max-width: 140px" rowspan="3"></td>
                        </tr>
                        <!--                    <tr>-->
